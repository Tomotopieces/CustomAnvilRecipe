...
public class CreateGUI extends InventoryGUI {
    private static final String leftSettingsButtonName = "§r§b§l§oLeft Material Settings";
    private static final String rightSettingsButtonName = "§r§b§l§oRight Material Settings";
    ...
    public void openInventoryGUI() {
        Inventory create = Bukkit.createInventory(player, 3*9, guiName);
    ...
    public static String getLeftSettingsButtonName() {
        return leftSettingsButtonName;
    }

    public static String getRightSettingsButtonName() {
        return rightSettingsButtonName;
    }
